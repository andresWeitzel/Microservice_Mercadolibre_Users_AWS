 ...
 */
const getLikeUpdateDate = async function (event) {
  try {
    usersList = null;
    //pagination
    pageSizeNro = 5;
    ...
    updateDatParam = await event.pathParameters.updateDate;

    validatePathParam = await validatePathParameters(updateDatParam);
