...
//Errors
const GET_LIKE_EMAIL_USERS_BAD_REQUEST_DETAIL =
  'Bad request, could not get paginated list of users according to email. Try again.';
const GET_LIKE_EMAIL_USERS_ERROR_DETAIL =
  ...
  try {
    ...
    switch (userList) {
      ...
      case null:
        return await requestResult(
          BAD_REQUEST_CODE,
          GET_LIKE_EMAIL_USERS_BAD_REQUEST_DETAIL,
        );
      default:
    ...
    msgResponse = GET_LIKE_EMAIL_USERS_ERROR_DETAIL;
