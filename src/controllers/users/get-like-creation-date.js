...
//Errors
const GET_LIKE_CREATION_DATE_BAD_REQUEST_DETAIL =
  'Bad request, could not get paginated list of users according to creation date. Try again.';
const GET_LIKE_CREATION_DATE_USERS_ERROR_DETAIL =
  'ERROR in get-like-creation-date lambda function.';
//Vars
let userList;
let eventHeaders;
  ...
  try {
    ...
    switch (userList) {
      ...
      case null:
        return await requestResult(
          BAD_REQUEST_CODE,
          GET_LIKE_CREATION_DATE_BAD_REQUEST_DETAIL,
        );
      default:
    ...
    msgResponse = GET_LIKE_CREATION_DATE_USERS_ERROR_DETAIL;
