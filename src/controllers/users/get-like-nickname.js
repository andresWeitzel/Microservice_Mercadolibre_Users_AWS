...
const {
  getLikeNickname
} = require('../../services/users/get-like-nickname');
//Enums
const {
  statusCode
...
module.exports.handler = async (event) => {
  try {
    ...
    validatePathParam = await validatePathParameters(nickname);
    ...
    //-- start with db query  ---
    userList = await getLikeNickname(nickname, pageSizeNro, pageNro, order);
    ...
    msg = `Error in getLikeNickname lambda. Caused by ${error}`;
