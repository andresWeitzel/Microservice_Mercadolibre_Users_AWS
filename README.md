...
Microservicio para la gestión de usuarios replicando y modificando parte de la arquitectura de desarrollo de ML. Las tecnologías implementadas son Parameter Storage, Api-Gateway, Serverless-Framework, Lambda, NodeJs, Sequelize, Mysql, entre otros. 
